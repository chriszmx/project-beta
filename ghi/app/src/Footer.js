    ...
    return (
        ...
        <div className="container p-2">
            ...
            <div className="col-lg-6 col-md-12 mb-4 mb-md-0">
                ...
                CarCar is the ultimate solution for automobile dealership
                management. Our state-of-the-art software helps dealerships
                streamline their operations, increase efficiency, and boost sales.
                </p>
            </div>
            </div>
        </div>

        <div className="text-center p-3">© 2023 CarCar</div>
        </footer>
    );
}
